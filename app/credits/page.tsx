  ...
  },
  {
    ...
    people: [
      ...
      },
      {
        ...
        role: "Beta Tester",
        description:
          "The First man to use a website Generated by Eribot, made sure that worked and the tutorial was okay to follow",
        imageUrl: "/Keag.png",
...
const PersonCard = ({
  ...
  >
    ...
    <div className="flex-1 text-center md:text-left">
      ...
      <h4
        className={`text-m font-bold ${colorScheme.text} ${colorScheme.darkText}`}
      >
        {person.role}
      </h4>
